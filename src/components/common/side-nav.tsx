    ...
    <section className=" flex flex-col ">
      ...
      >
        <div className="flex gap-x-6 items-center">
          <RxHamburgerMenu onClick={toggleNav} className="text-3xl text-white cursor-pointer" />
          <CiSearch className="text-3xl text-white cursor-pointer" />
        </div>
        <div className="relative w-10 h-10 rounded-full">
          <Image src={"/assests/images/rounded-profile.png"} alt="" fill objectFit="cover" sizes="100%" />
        </div>
      </div>
          ...
          <ul className="mt-4">
            ...
            <li
              className={`flex items-center gap-x-8 max-md:mb-6 mb-10 font-semibold text-[20px] leading-7 dark:text-white ${
                pathname === "dashboard" ? "bg-[#98a1cf] text-white rounded-[10px]" : ""
              }`}
            >
            ...
            <li
              className={`flex items-center gap-x-8 mb-10 max-md:mb-6 font-semibold text-[20px] leading-7 dark:text-white ${
                pathname === "history" ? "bg-mainColor text-white  rounded-[10px]" : ""
              }`}
            >
